...
Data used in this paper is extracted from table 10.9.1: Perception of the risk of getting AIDS: women and table 10.9.2 Perception of the risk of getting AIDS: men from the Kenya Demographic and Health Survey 1998 report [@DHS]. These two tables illustrate the female and male populations’ perceptions of their risk of getting the AIDS virus. Based on the tables, the independent variables include genders, age groups, marital status, number of sexual partners other than spouse, residence, province, and education. This report focuses on five variables from the data set: the gender, age, number of sexual partners, province and education. The marital status and residence are dropped. To sum up, all these five variables are analyzed in this report, and their impacts on the response variable, people’s perception of the risk of getting AIDS, are discussed. 
...
province_diverging %>% filter(gender == "female")%>%
  ...
  labs(
    title = "What is your chances of getting AIDS? (Female)",
    x = "Provinces",
    fill = NULL
  ) +
  theme_minimal() +
